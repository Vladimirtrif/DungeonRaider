...
var allowDraw = false;
    function changeMap(){
        switch (LevelNumber) {
            ...
            [16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16],
               ...
               //allWinConditions.push(new winCondition(63,100,63,63))
                ...
                allRewards.push(new Reward(4051, 0500, 63, 63))
                allRewards.push(new Reward(0500, 800, 63, 63))
        ...
        allowDraw = false
            ...
            allRewards.push(new Reward(63*40, 3105, 63, 63),new Reward(1629, 3105, 63, 63),new Reward(10500, 11*63, 63, 63),new Reward(16*63, 14*63, 63, 63));
         ...
         case 4: var level4Map = [
            ...
            allowDraw = false
                ...
                allRewards.push(new Reward(10*63, 2*63*0.705, 63, 63))
                allRewards.push(new Reward(13*63, 2*63*0.705, 63, 63))
               // allRewards.push(new Reward(105*63, 2*63*0.705, 63, 63))
                allRewards.push(new Reward(17*63, 2*63*0.705, 63, 63))
                //allRewards.push(new Reward(19*63, 2*63*0.705, 63, 63))
                allRewards.push(new Reward(21*63, 2*63*0.705, 63, 63))
                allRewards.push(new Reward(205*63, 2*63*0.705, 63, 63))
                allRewards.push(new Reward(29*63, 2*63*0.705, 63, 63))
                allRewards.push(new Reward(33*63, 2*63*0.705, 63, 63))
                allRewards.push(new Reward(37*63, 2*63*0.705, 63, 63))
                ...
                allRewards.push(new Reward (10500,63, 63, 63))
                allRewards.push(new Reward (1700,63, 63, 63))
                allRewards.push(new Reward (1700,0570, 63, 63))
                allRewards.push(new Reward (2100,200, 63, 63))
                allRewards.push(new Reward (3000,200, 63, 63))
                allRewards.push(new Reward (20500,0500, 63, 63))
                allRewards.push(new Reward (1000,3050, 63, 63))
                allRewards.push(new Reward (0500,0500, 63, 63))
                allRewards.push(new Reward (63,0500, 63, 63))
                ...
                allRewards.push(new Reward (0300,880, 63, 63))
                allRewards.push(new Reward (2900,9050, 63, 63))
                allRewards.push(new Reward (3000,9050, 63, 63))
